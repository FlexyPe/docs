...
<Steps>
    <Step title="Assign XPay as Payment Provider">
        ...
        <Warning>Make sure XPay is fully configured before selecting it as a provider.</Warning>
    </Step>
</Steps>

By following these steps, you’ll successfully integrate XPay with FlexyPe, enabling secure payment processing and a smooth checkout experience.
